...
class TRAINER:
    def __init__(self, args=None):
        ...
        # save ordered ar1706924015.448.png  1706924015.938.png  1706924016.418.png  1706924016.938.pnggs, config, and a logfile to write stdout to
        if self.args is not None:
        ...
        self.dataset_dir = opj1706924015.448.png  1706924015.938.png  1706924016.418.png  1706924016.938.png(self.datadir, self.dataset_name)
        ...
        elif self.model_type == 'LightweightViT':
            self.model = model_library.LightweightViT().to(self.device).float()
        else:
